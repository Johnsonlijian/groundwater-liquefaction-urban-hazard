# Regional groundwater trends and liquefaction-screening priorities

This repository is the clean reproducibility package for the paper:

**Regional groundwater trends create bidirectional liquefaction-screening priorities in seismic cities**
